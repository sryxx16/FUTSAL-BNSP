      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8">
         ...
         <div className="space-y-6">
            ...
            <button 
              onClick={handleSave} 
              disabled={saving}
              className="bg-emerald-500 text-slate-950 font-bold px-6 py-3 rounded-lg hover:bg-emerald-400 transition-colors shadow-[0_0_15px_rgba(16,185,129,0.2)] disabled:opacity-50 mt-4"
            >
