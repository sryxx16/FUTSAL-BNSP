  ...
  return (
    <div className="max-w-4xl space-y-8">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 md:p-8">
         <h3 className="text-xl font-bold text-white mb-6 border-b border-slate-800 pb-4">Pengaturan Harga Lapangan</h3>
         <div className="space-y-6">
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 {lapangan.map(lap => (
                   <div key={lap.id}>
                     <label className="text-sm font-medium text-slate-400 block mb-2">{lap.nama} (Rp)</label>
                     <input 
                       type="number" 
